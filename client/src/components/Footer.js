          ...
          <Col lg={4} md={6} className="mb-4">
            <div className="footer-section">
              ...
              <div className="social-links">
                <a href="https://github.com/madhu-527" className="social-link" title="GitHub" target="_blank" rel="noopener noreferrer">
                  <FaGithub />
                </a>
                <a href="https://www.linkedin.com/in/madhubabu27" className="social-link" title="LinkedIn" target="_blank" rel="noopener noreferrer">
                  <FaLinkedin />
                </a>
